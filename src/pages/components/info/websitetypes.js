                ...
                <div className={styles.website_types_wrapper}>
                    ...
                    <ol className={styles.list_wrapper}>
                        <li className={styles.list_element_second}>
                            <h2 className={styles.description}>Static Websites</h2>
                        </li>
                    ...
                    <ol className={styles.list_wrapper}>
                        <li className={styles.list_element_second}>
                            <h2 className={styles.description}>Dynamic Websites</h2>
                        </li>
                    ...
                    <ol className={styles.list_wrapper}>
                        <li className={styles.list_element_second}>
                            <h2 className={styles.description}>Ecommerce Websites</h2>
                        </li>
