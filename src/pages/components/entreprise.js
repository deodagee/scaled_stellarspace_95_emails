                  ...
                  <li className={styles.tab_5}>
                    <p>Entreprise</p>
                      ...
                      <span className={styles.popupContent}>
                        ...
                        When purchasing a website you must decide wether you need a web developer or designer to get the site up and running. If you&apos;ve already got a site ready to go, I can get it deployed for you for a lesser fee, depending on the scope and size of the project. However, in the case that you need the site built from the ground up, you can get this service anywhere, but the fee is usually in the astronomical ranges of $800 and $3000 in the general market. But with Astrum Stellar at StellarSpace, the price to develop and deploy a website from scratch is quite low compared to that. In fact, If you manage to find a better price anywhere, let me know and I will make sure to match it or give you a lower price. No Boast, GUARANTEED. 
                        </span>
